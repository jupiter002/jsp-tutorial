      ...
      <div class="row justity-content-center">
        <div class="col-6">
          <div class="form-floating mb-3">
            <input type="text" name="userId" class="form-control form-control-lg" id="floatingInput" placeholder="아이디를 입력해주세요" />
            <label for="floatingInput">ID</label>
            <!--label때문에 placeholder가 동작안함-->
          </div>
          <div class="form-floating mb-3">
          ...
          <div class="text-center"><button type="submit" class="btn btn-outline-primary btn-lg">Join</button></div>
        </div>
      </div>
    </div>
  </form>
