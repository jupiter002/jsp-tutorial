...
<form action="../member/modify-process" method="post" class="join" name="joinForm">
      ...
      <div class="col-6">
        ...
        <div class="form">
          <div class="input-group mb-3">
            <input type="text" class="form-control form-control-lg" name="zonecode" id="zonecode" placeholder="우편번호" readonly value= "${ infoMemeberDto.email }" />
        ...
        <div class="row mb-3">
          <div class="col">
            <input type="text" class="form-control-lg detailAddress" placeholder="참고사항" name="detailAddress" value="${ infoMemeberDto.detailaddress }" />
          </div>
          <div class="col">
            <input type="text" class="form-control-lg extraAddress" placeholder="상세주소" name="extraAddress" value="${ infoMemberDtp.extraddress }" />
          </div>
        </div>

        <div class="text-center"><button type="submit" id="btnSubmit" class="btn btn-outline-primary btn-lg">회원정보 수정</button></div>
      </div>
    </div>
  </div>
</form>
